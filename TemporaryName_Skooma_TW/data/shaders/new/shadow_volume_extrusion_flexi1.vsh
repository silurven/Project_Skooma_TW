...
mova a0.x, r4.x
m4x3 r5.xyz, v0, c[a0.x + 6]; transform position
m3x3 r6.xyz, v3, c[a0.x + 6]; transform normal
mov r6.w, c0.x
mov r5.w, c0.x
...
m4x4 oPos.xyzw, r3, c1; transform the new position into homogenous clip space and output
