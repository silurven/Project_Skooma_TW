...
; c9-12 = Tex Transform 1
; c13-c96	= 28 Object -> World Transforms
; -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
...
m4x3	r4, v0, c[a0.x+13] ; world position of vertex
mov r4.w, c0.x
...
m3x3	r1, v2, c[a0.x+13] ; transform the normal into world space 
...
#line 75 "instanced_tgen_1.vsh"
;
; Pass through the texture coordinates
;

mov	oT0, v3
m4x4 oT1, r4, c9 ; generate world space coordinate.
